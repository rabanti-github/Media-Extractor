...
namespace SetupProject2
{
    public static class Program
    {
        static void Main()
        {
            ...
            project.ManagedUI.InstallDialogs.Add<SetupProject2.LanguageSelectionDialog>()
                                            .Add<SetupProject2.WelcomeDialog>()
                                            .Add<SetupProject2.LicenceDialog>()
                                            .Add<SetupProject2.LegacyCheckDialog>()
                                            .Add<SetupProject2.SetupTypeDialog>()
            ...
            project.ManagedUI.ModifyDialogs.Add<SetupProject2.LanguageSelectionDialog>()
                                           .Add<SetupProject2.MaintenanceTypeDialog>()
                                           .Add<SetupProject2.FeaturesDialog>()
                                           .Add<SetupProject2.ProgressDialog>()
                                           .Add<SetupProject2.ExitDialog>();
            #endregion
        ...
        {
            var temp = Path.Combine(Path.GetTempPath(), "D:\\Dev\\NET\\Media-Extractor\\SetupProject2\\output\\installer_debug.txt");
